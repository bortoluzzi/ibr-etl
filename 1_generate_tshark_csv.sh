...
do
	...
	time tshark -r $f -M 100000 -t ad -T fields -e _ws.col.Time -e ip.src -e ip.dst -e tcp.dstport -e udp.dstport -e icmp.type -Eseparator=, --log-level "critical" | gzip -c >> output.csv.gz
done
echo "tshark end"
